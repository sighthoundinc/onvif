...
const linerase = function(xml) {
	...
	if (typeof xml === 'object') {
		...
		if (numberRE.test(xml)) {
			var num = parseFloat(xml);
			return num > Number.MAX_SAFE_INTEGER ? xml : num;
		}
...
var lineraseCustom = () => false;
const lineraseCustomSet = function (lc) {
	lineraseCustom = lc;
}
...
module.exports = {
	linerase: linerase
	, lineraseCustomSet: lineraseCustomSet
